...
if __name__ == '__main__':
    ...
    print("--- Running Hello World (clang++) ---")
    ...
    # 1c. Invalid Compiler
    print("--- Running with Invalid Compiler ---")
    ...
    """
    print("--- Running STDIN/STDOUT Example (clang++) ---")
    ...
    """
    print("--- Running Compilation Error Example (g++) ---")
    ...
    """
    print("--- Running Execution Timeout Example (g++) ---")
    ...
    print("--- Running Compilation Timeout Example (clang++) ---")
    ...
    """
    print("--- Running Runtime Error Example (g++) ---")
    ...
    print("--- Running No Input For Code Expecting Input (clang++) ---")
